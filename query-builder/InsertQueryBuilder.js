            ...
            valueSets.forEach(function (valueSet, valueSetIndex) {
                columns.forEach(function (column, columnIndex) {
                    ...
                    if (column.isVersion) {
                        ...
                        if (_this.connection.driver instanceof AbstractSqliteDriver_1.AbstractSqliteDriver || _this.connection.driver instanceof SapDriver_1.SapDriver || _this.connection.driver instanceof FirebirdDriver_1.FirebirdDriver) { // unfortunately sqlite does not support DEFAULT expression in INSERT queries
