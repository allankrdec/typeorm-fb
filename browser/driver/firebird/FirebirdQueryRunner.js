...
import { ISOLATION_READ_COMMITED, ISOLATION_READ_UNCOMMITTED, ISOLATION_REPEATABLE_READ, ISOLATION_SERIALIZABLE } from "node-firebird";
    ...
    FirebirdQueryRunner.prototype.createDatabase = function (database, ifNotExist) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        up = new Query(ifNotExist ? "CREATE DATABASE IF NOT EXISTS " + database : "CREATE DATABASE " + database);
                        down = new Query("DROP DATABASE " + database);
    ...
    FirebirdQueryRunner.prototype.dropDatabase = function (database, ifExist) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        up = new Query(ifExist ? "DROP DATABASE IF EXISTS " + database : "DROP DATABASE " + database);
                        down = new Query("CREATE DATABASE " + database);
                        return [4 /*yield*/, this.executeQueries(up, down)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
