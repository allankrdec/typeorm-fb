            ...
            valueSets.forEach(function (valueSet, valueSetIndex) {
                columns.forEach(function (column, columnIndex) {
                    ...
                    if (column.isVersion) {
                        ...
                        if (_this.connection.driver instanceof AbstractSqliteDriver || _this.connection.driver instanceof SapDriver || _this.connection.driver instanceof FirebirdDriver) { // unfortunately sqlite does not support DEFAULT expression in INSERT queries
