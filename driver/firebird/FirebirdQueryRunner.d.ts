...
export declare class FirebirdQueryRunner extends BaseQueryRunner implements QueryRunner {
    /**
    ...
    constructor(driver: FirebirdDriver, mode?: "master" | "slave");
    /**
    ...
    getTransaction(isolationLevel?: IsolationLevel): Promise<Transaction>;
    /**
