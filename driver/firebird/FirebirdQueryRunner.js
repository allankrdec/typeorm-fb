...
var FirebirdError_1 = require("./FirebirdError");
var OrmUtils_1 = require("../../util/OrmUtils");
var Query_1 = require("../Query");
var FirebirdQueryRunner = /** @class */ (function (_super) {
    tslib_1.__extends(FirebirdQueryRunner, _super);
    // -------------------------------------------------------------------------
    // Constructor
    // -------------------------------------------------------------------------
    function FirebirdQueryRunner(driver, mode) {
     ...
     */
    FirebirdQueryRunner.prototype.connect = function () {
     ...
     */
    FirebirdQueryRunner.prototype.release = function () {
        this.isReleased = true;
        if (this.databaseConnection)
            this.databaseConnection.release();
        return Promise.resolve();
    };
    FirebirdQueryRunner.prototype.translateIsolationLevel = function (isolationLevel) {
        switch (isolationLevel) {
            case "READ COMMITTED":
                return node_firebird_1.ISOLATION_READ_COMMITED;
            case "READ UNCOMMITTED":
                return node_firebird_1.ISOLATION_READ_UNCOMMITTED;
            case "REPEATABLE READ":
                return node_firebird_1.ISOLATION_REPEATABLE_READ;
            case "SERIALIZABLE":
                return node_firebird_1.ISOLATION_SERIALIZABLE;
            default:
                return [];
        }
    };
    FirebirdQueryRunner.prototype.getTransaction = function (isolationLevel) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (ok, fail) {
                        var isolationLevelFirebird = _this.translateIsolationLevel(isolationLevel || "READ COMMITTED");
                        _this.driver.firebirdDatabase.transaction(isolationLevelFirebird, function (err, transaction) {
                            if (err) {
                                fail(err);
                            }
                            ok(transaction);
     ...
     */
    FirebirdQueryRunner.prototype.startTransaction = function (isolationLevel) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.getTransaction(isolationLevel)];
                    case 1:
     ...
     */
    FirebirdQueryRunner.prototype.commitTransaction = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                if (!this.isTransactionActive)
                ...
                return [2 /*return*/, new Promise(function (ok, fail) {
                        _this.transaction.commit(function (err) {
                            if (err)
                                fail(err);
     ...
     * Error will be thrown if transaction was not started.
     */
    FirebirdQueryRunner.prototype.rollbackTransaction = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                if (!this.isTransactionActive)
                    throw new TransactionNotStartedError_1.TransactionNotStartedError();
                return [2 /*return*/, new Promise(function (ok, fail) {
                        _this.transaction.rollback(function (err) {
                            if (err)
                                fail(err);
                            _this.isTransactionActive = false;
                            ok();
            ...
            return tslib_1.__generator(this, function (_a) {
                try {
                    ...
                    callback = function (err, result, meta) {
                        ...
                        var streamToString = function (stream, encoding) {
                            var chunks = [];
                            return new Promise(function (resolve, reject) {
                                stream.on('data', function (chunk) { return chunks.push(chunk); });
                                stream.on('error', reject);
                                stream.on('end', function () { return resolve(Buffer.concat(chunks).toString(encoding)); });
                            });
                        };
                        var blobPromises = [];
                        var createBlobPromise = function (obj, alias, val) {
                            return new Promise(function (resolve, reject) {
                                val(function (err, name, stream) {
                                    if (err) {
                                        reject(err);
                                        return;
                                    }
                                    ...
                                    if (!stream['setEncoding']) {
                                        stream['setEncoding'] = function () { return undefined; };
                                    }
                                    resolve(streamToString(stream, 'latin1').then(function (blobString) {
                                        obj[alias] = blobString;
                                    }));
                                });
                            });
                        };
                        var convertedResult = result && result.map(function (row) { return meta.reduce(function (obj, col, colNumber) {
                            var val = row[colNumber];
                        ...
                        Promise.all(blobPromises).then(function () { return ok(convertedResult); });
                    };
                    if (this.isTransactionActive) {
     ...
     */
    FirebirdQueryRunner.prototype.stream = function (query, parameters, onEnd, onError) {
        throw new FirebirdError_1.FirebirdError("Stream query not supported");
    };
    /**
     * Returns all available database names including system databases.
     */
    FirebirdQueryRunner.prototype.getDatabases = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, Promise.resolve([])];
            });
     ...
     */
    FirebirdQueryRunner.prototype.getSchemas = function (database) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
     ...
     */
    FirebirdQueryRunner.prototype.hasDatabase = function (database) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
     ...
     */
    FirebirdQueryRunner.prototype.hasSchema = function (schema) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                throw new Error("Firebird driver does not support table schemas");
            });
     ...
     */
    FirebirdQueryRunner.prototype.hasTable = function (tableOrName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        sql = "SELECT * FROM RDB$RELATIONS WHERE RDB$FLAGS= 1 AND RDB$RELATION_NAME = '" + parsedTableName.tableName + "'";
     ...
     */
    FirebirdQueryRunner.prototype.hasColumn = function (tableOrName, column) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        sql = "SELECT * FROM RDB$RELATION_FIELDS WHERE RDB$RELATION_NAME = '" + parsedTableName.tableName + "' AND RDB$FIELD_NAME = '" + columnName + "'";
                        return [4 /*yield*/, this.query(sql)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.length ? true : false];
     ...
     */
    FirebirdQueryRunner.prototype.createDatabase = function (database, ifNotExist) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var up, down;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        up = new Query_1.Query(ifNotExist ? "CREATE DATABASE IF NOT EXISTS " + database : "CREATE DATABASE " + database);
                        down = new Query_1.Query("DROP DATABASE " + database);
     ...
     * Drops database.
     */
    FirebirdQueryRunner.prototype.dropDatabase = function (database, ifExist) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var up, down;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        up = new Query_1.Query(ifExist ? "DROP DATABASE IF EXISTS " + database : "DROP DATABASE " + database);
                        down = new Query_1.Query("CREATE DATABASE " + database);
                        return [4 /*yield*/, this.executeQueries(up, down)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
     ...
     */
    FirebirdQueryRunner.prototype.createSchema = function (schema, ifNotExist) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
     ...
     * Drops table schema.
     */
    FirebirdQueryRunner.prototype.dropSchema = function (schemaPath, ifExist) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
     ...
     * Creates a new table.
     */
    FirebirdQueryRunner.prototype.createTable = function (table, ifNotExist, createForeignKeys) {
        if (ifNotExist === void 0) { ifNotExist = false; }
        if (createForeignKeys === void 0) { createForeignKeys = true; }
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var downQueries, isTableExist, upQueries;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
     ...
     * Drop the table.
     */
    FirebirdQueryRunner.prototype.dropTable = function (target, ifExist, dropForeignKeys) {
        if (dropForeignKeys === void 0) { dropForeignKeys = true; }
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var isTableExist, createForeignKeys, downQueries, tableName, table, upQueries;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
     ...
     * Creates a new view.
     */
    FirebirdQueryRunner.prototype.createView = function (view) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
     ...
     * Drops the view.
     */
    FirebirdQueryRunner.prototype.dropView = function (target) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
     ...
     */
    FirebirdQueryRunner.prototype.renameTable = function (oldTableOrName, newTableName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
     ...
     */
    FirebirdQueryRunner.prototype.addColumn = function (tableOrName, column) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var downQueries, table, _a, clonedTable, upQueries, skipColumnLevelPrimary, generatedColumn, nonGeneratedColumn, primaryColumns, columnNames, nonGeneratedColumn, columnIndex, uniqueIndex;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        downQueries = [];
     ...
     */
    FirebirdQueryRunner.prototype.addColumns = function (tableOrName, columns) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, PromiseUtils_1.PromiseUtils.runInSequence(columns, function (column) { return _this.addColumn(tableOrName, column); })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     */
    FirebirdQueryRunner.prototype.renameColumn = function (tableOrName, oldTableColumnOrName, newTableColumnOrName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
     ...
     */
    FirebirdQueryRunner.prototype.changeColumn = function (tableOrName, oldColumnOrName, newColumn) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var downQueries, table, _a, clonedTable, upQueries, oldColumn, oldTableColumn, generatedColumn, nonGeneratedColumn, primaryColumns, columnNames, column, columnNames, primaryColumn, column, columnNames, nonGeneratedColumn, uniqueIndex, uniqueIndex_1, tableUnique;
            var _this = this;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
     ...
     * Changes a column in the table.
     */
    FirebirdQueryRunner.prototype.changeColumns = function (tableOrName, changedColumns) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, PromiseUtils_1.PromiseUtils.runInSequence(changedColumns, function (changedColumn) { return _this.changeColumn(tableOrName, changedColumn.oldColumn, changedColumn.newColumn); })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     */
    FirebirdQueryRunner.prototype.dropColumn = function (tableOrName, columnOrName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var table, _a, column, downQueries, clonedTable, upQueries, generatedColumn, nonGeneratedColumn, columnNames, tableColumn, columnNames_1, nonGeneratedColumn, columnIndex, uniqueName_1, foundUnique, indexName_1, foundIndex;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(tableOrName instanceof Table_1.Table)) return [3 /*break*/, 1];
     ...
     */
    FirebirdQueryRunner.prototype.dropColumns = function (tableOrName, columns) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, PromiseUtils_1.PromiseUtils.runInSequence(columns, function (column) { return _this.dropColumn(tableOrName, column); })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     */
    FirebirdQueryRunner.prototype.createPrimaryKey = function (tableOrName, columnNames) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
     ...
     */
    FirebirdQueryRunner.prototype.updatePrimaryKeys = function (tableOrName, columns) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
     ...
     * Drops a primary key.
     */
    FirebirdQueryRunner.prototype.dropPrimaryKey = function (tableOrName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
     ...
     */
    FirebirdQueryRunner.prototype.createUniqueConstraint = function (tableOrName, uniqueConstraint) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
     ...
     */
    FirebirdQueryRunner.prototype.createUniqueConstraints = function (tableOrName, uniqueConstraints) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                throw new Error("Firebird does not support unique constraints. Use unique index instead.");
            });
     ...
     */
    FirebirdQueryRunner.prototype.dropUniqueConstraint = function (tableOrName, uniqueOrName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                throw new Error("Firebird does not support unique constraints. Use unique index instead.");
            });
     ...
     */
    FirebirdQueryRunner.prototype.dropUniqueConstraints = function (tableOrName, uniqueConstraints) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                throw new Error("Firebird does not support unique constraints. Use unique index instead.");
            });
     ...
     */
    FirebirdQueryRunner.prototype.createCheckConstraint = function (tableOrName, checkConstraint) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
     ...
     */
    FirebirdQueryRunner.prototype.createCheckConstraints = function (tableOrName, checkConstraints) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                throw new Error("Firebird does not support check constraints.");
            });
     ...
     */
    FirebirdQueryRunner.prototype.dropCheckConstraint = function (tableOrName, checkOrName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                throw new Error("Firebird does not support check constraints.");
            });
     ...
     */
    FirebirdQueryRunner.prototype.dropCheckConstraints = function (tableOrName, checkConstraints) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                throw new Error("Firebird does not support check constraints.");
            });
     ...
     */
    FirebirdQueryRunner.prototype.createExclusionConstraint = function (tableOrName, exclusionConstraint) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    FirebirdQueryRunner.prototype.createExclusionConstraints = function (tableOrName, exclusionConstraints) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve()];
     ...
     */
    FirebirdQueryRunner.prototype.dropExclusionConstraint = function (tableOrName, exclusionOrName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve()];
     ...
     */
    FirebirdQueryRunner.prototype.dropExclusionConstraints = function (tableOrName, exclusionConstraints) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve()];
     ...
     */
    FirebirdQueryRunner.prototype.createForeignKey = function (tableOrName, foreignKey) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var table, _a, up, down;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
     ...
     */
    FirebirdQueryRunner.prototype.createForeignKeys = function (tableOrName, foreignKeys) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var promises;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
     ...
     * Drops a foreign key.
     */
    FirebirdQueryRunner.prototype.dropForeignKey = function (tableOrName, foreignKeyOrName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
     ...
     */
    FirebirdQueryRunner.prototype.dropForeignKeys = function (tableOrName, foreignKeys) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var promises;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
     ...
     * Creates a new index.
     */
    FirebirdQueryRunner.prototype.createIndex = function (tableOrName, index) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var table, _a, up, down;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
     ...
     */
    FirebirdQueryRunner.prototype.createIndices = function (tableOrName, indices) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var promises;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
     ...
     * Drops an index.
     */
    FirebirdQueryRunner.prototype.dropIndex = function (tableOrName, indexOrName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
     ...
     */
    FirebirdQueryRunner.prototype.dropIndices = function (tableOrName, indices) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var promises;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
     ...
     */
    FirebirdQueryRunner.prototype.clearTable = function (tableOrName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    FirebirdQueryRunner.prototype.clearDatabase = function (database) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
     ...
     */
    FirebirdQueryRunner.prototype.getCurrentDatabase = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, this.driver.database || ""];
            });
        });
    };
    FirebirdQueryRunner.prototype.loadViews = function (viewNames) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var hasTable, viewsCondition, query, dbViews;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        viewsCondition = viewNames.map(function (tableName) {
                            var _a = tslib_1.__read(tableName.split("."), 2), name = _a[1];
                            return "(t.name = '" + name + "')";
                        }).join(" OR ");
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, dbViews.map(function (dbView) {
                                ...
                                view.name = _this.driver.buildTableName(dbView["name"], undefined, undefined);
     ...
     */
    FirebirdQueryRunner.prototype.loadTables = function (tableNames) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
     ...
     */
    FirebirdQueryRunner.prototype.createTableSql = function (table, createForeignKeys) {
        var _this = this;
     ...
     */
    FirebirdQueryRunner.prototype.dropTableSql = function (tableOrName) {
        return new Query_1.Query("DROP TABLE " + this.escapePath(tableOrName));
    };
    FirebirdQueryRunner.prototype.createViewSql = function (view) {
    ...
    FirebirdQueryRunner.prototype.insertViewDefinitionSql = function (view) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var name, expression, _a, query, parameters;
            return tslib_1.__generator(this, function (_b) {
                name = view.name;
     ...
     */
    FirebirdQueryRunner.prototype.dropViewSql = function (viewOrPath) {
        return new Query_1.Query("DROP VIEW " + this.escapePath(viewOrPath));
    };
    /**
     * Builds remove view sql.
     */
    FirebirdQueryRunner.prototype.deleteViewDefinitionSql = function (viewOrPath) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var viewName, name, qb, _a, query, parameters;
            return tslib_1.__generator(this, function (_b) {
     ...
     */
    FirebirdQueryRunner.prototype.createIndexSql = function (table, index) {
     ...
     */
    FirebirdQueryRunner.prototype.dropIndexSql = function (table, indexOrName) {
     ...
     */
    FirebirdQueryRunner.prototype.createPrimaryKeySql = function (table, columnNames) {
     ...
     */
    FirebirdQueryRunner.prototype.dropPrimaryKeySql = function (table) {
        return new Query_1.Query("ALTER TABLE " + this.escapePath(table) + " DROP PRIMARY KEY");
    };
    /**
     * Builds create foreign key sql.
     */
    FirebirdQueryRunner.prototype.createForeignKeySql = function (table, foreignKey) {
        var columnNames = foreignKey.columnNames.map(function (column) { return "" + column; }).join(", ");
        var referencedColumnNames = foreignKey.referencedColumnNames.map(function (column) { return "" + column; }).join(",");
     ...
     */
    FirebirdQueryRunner.prototype.dropForeignKeySql = function (table, foreignKeyOrName) {
    ...
    FirebirdQueryRunner.prototype.parseTableName = function (target) {
     ...
     */
    FirebirdQueryRunner.prototype.escapePath = function (target, disableEscape) {
     ...
     */
    FirebirdQueryRunner.prototype.buildCreateColumnSql = function (column, skipPrimary, skipName) {
    ...
    return FirebirdQueryRunner;
}(BaseQueryRunner_1.BaseQueryRunner));
exports.FirebirdQueryRunner = FirebirdQueryRunner;

//# sourceMappingURL=FirebirdQueryRunner.js.map
